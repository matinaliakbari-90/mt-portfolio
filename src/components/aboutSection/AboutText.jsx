...
const AboutText = () => {
    return (
        <div className="text-center md:text-left">
            ...
            <p className="mt-10 w-full md:w-[25rem] lg:w-[43rem] lg:text-justify text-balance">I am Matin AliAkbari, a passionate web developer with a passion for coding and learning.
