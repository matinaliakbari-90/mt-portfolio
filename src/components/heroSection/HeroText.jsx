...
const HeroText = () => {
    return (
        <div className="flex flex-col justify-center gap-4 sm:text-center md:text-left">
            ...
            <motion.p variants={fadeIn('up', 0.6)} initial='hidden' whileInView='show' viewport={{ once: false, amount: 0 }} className="mt-4 text-lg">A Passionate Web Developer and Creative <br />
                with 2 years of experience.</motion.p>
        </div>
    )
}
