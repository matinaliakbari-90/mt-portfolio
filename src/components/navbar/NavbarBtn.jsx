...
const NavbarBtn = () => {
    return (
        <div className="border-[0.5px] border-cyan px-4 py-2 text-lg rounded-full font-body text-white md:text-xl font-bold cursor-pointer bg-gradient-to-r from-cyan bg-orange hover:shadow-cyanShadow hover:scale-110 transition-all duration-500">
